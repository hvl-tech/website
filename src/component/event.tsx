...
const Card=({datum,header,place,address,contain}: CardProps)=>{
    ...
    return (
            <div className=" border-4 border-black shadow-[4px_4px_0px_#000] p-4 w-full flex md:flex-row flex-col  items-center justify-between md:gap-6 gap-3 max-w-[1120px] ">
            <div
